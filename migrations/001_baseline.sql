...
-- ==========================================================================
--
-- Reproduces the full v0.1.0 schema exactly. Existing databases that were
-- initialized via `manage.py init-db` (schema.sql) are detected as having
-- this migration already applied — the migrate command checks for the
-- presence of the `settings` table before marking 001 as applied.
--
-- New deployments that start fresh will run this migration to create all
-- tables. After this, subsequent migrations (002, 003, ...) layer on top.
--
-- DO NOT MODIFY this file after release. Add a new migration instead.
-- ==========================================================================
